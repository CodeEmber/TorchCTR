...
interaction_path = get_file_path(['data', 'pixelrec', 'Pixel200K_inter.csv'])
image_path = get_file_path(['data', 'pixelrec', 'images'])
generate_lmdb_name = get_file_path(['data', 'pixelrec', 'image.lmdb'])
...
if __name__ == '__main__':
    ...
    lmdb_env = lmdb.open(lmdb_path, subdir=isdir, map_size=image_num * np.zeros((3, 224, 224)).nbytes * 10, readonly=False, meminit=False, map_async=True)
