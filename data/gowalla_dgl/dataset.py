...
class GowallaDglDataset(Dataset):
...
def get_gowalla_dgl_dataset(data: str, config: dict, phase: dict) -> GowallaDglDataset:
    dataset = GowallaDglDataset(data, config, phase)
    return dataset
