...
from utils.file_utils import get_file_path, get_new_file_path
...
# save_manager.save_json(enc_dict.get("map_dict"), get_file_path(['data', config["data"], 'map_dict.json']))
...
# test_df.to_csv('results/ddin/test_predictions.csv', index=False)
